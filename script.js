...
//set Interval. let timer = 10 mins.
// every sec, time --.
...
/*
  ...
  if (currentAccount.userName === document.querySelector('.form_input--user').value && currentAccount.pin === document.querySelector('.form__input--pin"').value)
